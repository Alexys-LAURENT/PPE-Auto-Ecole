...
$unControleur->addFormuleToUser($_SESSION['User']['id_e'], $_SESSION['offre'], $_SESSION['lePrix'], $typeBoite); //On ajoute la formule à l'utilisateur avec les variables qui sont set dans la page purchase.php
$_SESSION['User'] = $unControleur->verifConnection($_SESSION['User']['email_e'], $_SESSION['User']['mdp_e']); //on met à jour les données de l'utilisateur
