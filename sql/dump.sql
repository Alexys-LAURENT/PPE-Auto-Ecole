...
CREATE TABLE `planning` (
  ...
  PRIMARY KEY (`id_e`,`id_m`,`matricule`,`datehd`),
  KEY `id_e` (`id_e`),
  KEY `id_m` (`id_m`),
  KEY `planning_ibfk_3` (`matricule`),
  ...
  CONSTRAINT `planning_ibfk_3` FOREIGN KEY (`matricule`) REFERENCES `vehicule` (`matricule`)
...
VALUES (
        ...
        '{\"A\": \"Je passe\"}',
        'Le feu est vert depuis longtemps donc il pourrait passer à l\'orange. Il est préférable de ralentir au cas où celui-ci change de couleur. Je ralentis en lâchant l\'accélérateur et je mets mon pied devant le frein.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'Parmi les enfants tués lors d\'un accident mortel, quel est le pourcentage sur des trajets inférieurs à 3 km :',
        '{\"A\": \"10%\", \"B\": \"20%\", \"C\": \"30%\", \"D\": \"40%\"}',
        '{\"D\": \"40%\"}',
        'L\'excès de confiance est l\'une des grandes causes des accidents. La plupart des tués sur la route le sont à proximité de leur domicile (80 % des accidents mortels ont lieu dans le département du conducteur).Cette tendance se retrouve chez les enfants: 40 % des accidents mortels des enfants passagers ont lieu au cours de trajets de moins de 3 km, donc le plus souvent très près de la où ils habitent.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        '{\"A\": \"Quel que soit le temps\", \"B\": \"L\'été quand il fait chaud\", \"C\": \"L\'hiver quand il fait froid\"}',
        ...
        'Mon véhicule connait un problème mécanique. J\'allume mes feux de détresse et circule à allure réduite :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'J\'allume mes feux de détresse si je dois circuler à allure réduite à cause d\'un problème mécanique. Certains problèmes mécaniques (signale au tableau de bord par un voyant rouge) imposent un arrêt immédiat. Dans les autres cas, si je choisis de continuer de rouler, je dois le faire très prudemment (donc a allure réduite), et pour ne pas risquer de surprendre les autres usagers j\'allume mes feux de détresse.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        '{\"A\": \"Idéale\", \"B\": \"Conseillée\", \"C\": \"Dangereuse\", \"D\": \"Sécuritaire\"}',
        '{\"C\": \"Dangereuse\"}',
        'La position de cette conductrice est dangereuse car il ne faut surtout pas avoir les deux bras tendus jusqu\'au volant. Une bonne position de conduite permet d\'avoir les bras semi-fléchis quand les mains sont positionnées à 10h10.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"B\": \"Non\"}',
        'Cette molette sert à régler la hauteur des feux de croisement et non à effectuer des appels lumineux.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'Mon contrôle technique a été jugé défavorable pour au moins une défaillance majeure, je dois effectuer les réparations dans un délai de :',
        '{\"A\": \"1 mois\", \"B\": \"2 mois\"}',
        '{\"B\": \"2 mois\"}',
        'Mon contrôle technique a ete juge défavorable pour au moins une défaillance majeure;\nje dois effectuer les réparations dans un délai de 2 mois. Le contrôle technique est valide pendant 2 mois pendant lesquels je dois effectuer la contre-visite après avoir realise les réparations.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        '{\"A\": \"A\", \"B\": \"B\", \"C\": \"C\"}',
        '{\"C\": \"C\"}',
        'La principale zone d\'incertitude se trouve en zone C car je ne sais pas si les piétons qui marchent déjà sur la chaussée vont traverser. Je ralentis fortement et analyse leur comportement.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'Une femme enceinte peut être dispensée du port de la ceinture de sécurité sur certificat médical d\'un médecin agréé.',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Même si cela demeure dangereux pour le bébé et la maman en cas d\'accident (blessures plus graves), il est en effet possible d\'être dispensé du port de la ceinture de sécurité sur certificat médical. Cette dispense ne concerne pas que les femmes enceintes : n\'importe quelle raison médicale peut amener un médecin à délivrer un certificat de dispense. La personne concernée doit se déplacer avec le certificat pour pouvoir le présenter aux forces de l\'ordre.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'J\'ai oublié mon certificat d\'immatriculation lors d\'un contrôle routier, je risque une amende.',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Je risque en effet une amende de 11 euros si je présente le document dans les 5 jours au commissariat ou à la gendarmerie, et 135 euros si je dépasse ce délai.',
        'Mon véhicule est immobilisé :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"B\": \"Non\"}',
        'Mon véhicule n\'est pas immobilisé même si je ne peux pas présenter le certificat d\'immatriculation.'
    ), (
        11,
        ...
        'Téléphoner au volant perturbe la recherche visuelle d\'indices par le conducteur.',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Téléphoner au volant perturbe la recherche d\'indices de tous types (visuels, auditifs...) par le conducteur. Le conducteur analyse aussi moins bien les situations car son cerveau réalise plusieurs tâches à la fois. C\'est la raison pour laquelle l\'usage du téléphone au volant est interdit et sanctionné par une amende forfaitaire de 135 euros et un retrait de 3 points.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'Sur un trajet de 500 km, rouler à 120 km/h au lieu de 130 km/h sur autoroute permet d\'économiser jusqu\'à :',
        '{\"A\": \"2 litres de carburant\", \"B\": \"3 litres de carburant\", \"C\": \"4 litres de carburant\", \"D\": \"5 litres de carburant\"}',
        '{\"D\": \"5 litres de carburant\"}',
        'On estime que rouler 10 km/h moins vite permet d\'économiser 1L tous les 100 km. Donc sur un trajet de 500 km (ce qui fait 5 fois 100 km), cela permet d\'économiser jusqu\'à 5 litres de carburant.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'Lorsque je change une roue, je finis de serrer les écrous quand la roue est au sol.',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Lorsque je change une roue, je serre les écrous légèrement quand la roue est en l\'air, mais pas à fond. Pour finir le serrage, je dois descendre la voiture jusqu\'à ce que la roue soit au sol, et seulement ensuite je finis de serrer complètement les écrous.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'Des conditions idéales de circulation peuvent :',
        '{\"A\": \"Diminuer mon attention\", \"B\": \"Augmenter mon attention\"}',
        '{\"A\": \"Diminuer mon attention\"}',
        'Des conditions idéales de circulation peuvent paradoxalement diminuer mon attention car celle-ci n\'est pas maintenue en éveil par l\'arrivée de nouveaux éléments sur la route.',
        'Le risque de fatigue :',
        '{\"A\": \"Diminue\", \"B\": \"Augmente\"}',
        '{\"B\": \"Augmente\"}',
        'Le risque de fatigue augmente à cause de la monotonie du trajet.'
    ), (
        16,
        './images/Quiz/Question-4805.jpg',
        'Au STOP, je m\'arrête :',
        '{\"A\": \"A hauteur du panneau\", \"B\": \"À la limite de la chaussée abordée\"}',
        '{\"B\": \"À la limite de la chaussée abordée\"}',
        'On s\'arrête toujours au niveau de la ligne d\'effet du Stop, si elle est matérialisée par un marquage au sol. A défaut de ligne de Stop, on s\'arrête à la limite de la chaussée abordée, de façon à pouvoir vérifier qu\'aucun véhicule n\'arrive sans pour autant dépasser sur la voie sur laquelle il circulerait.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'Le stationnement du véhicule blanc est autorisé :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"B\": \"Non\"}',
        'Il est strictement interdit de s\'arrêter ou de stationner à proximité d\'une intersection.',
        'Son conducteur risque un retrait de 3 points :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Un arrêt ou un stationnement à proximité des intersections est sanctionné d\'une amende de 135 euros, d\'un retrait de 3 points et d\'une suspension maximale de 3 ans du permis de conduire. Notez bien que c\'est le conducteur et non pas le propriétaire du véhicule qui encourt le retrait de points et la suspension.'
    ), (
        20,
        './images/Quiz/Question-4809.jpg',
        'Certaines villes développent des modes de transport différents pour limiter l\'utilisation de la voiture :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Certaines villes développent des modes de transport différents pour limiter l\'utilisation de la voiture en créant des lignes de tramway, de bus et en offrant des services de vélos et de voitures en autopartage.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'Ce motocycliste a allumé ses feux. Je klaxonne :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"B\": \"Non\"}',
        'Les motocyclistes ont l\'obligation de circuler avec leurs feux de croisement, même de jour donc je ne klaxonne pas. De plus, l\'usage du klaxon en agglomération est interdit, sauf danger immédiat.',
        ...
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"B\": \"Non\"}',
        'Ralentir ne diminue pas mon temps de réaction car ce temps dépend de l\'état du conducteur. Seule une anticipation accrue de la part du conducteur peut diminuer le temps de réaction.',
        'Je diminue ma distance d\'arrêt :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'En revanche, ralentir permet de diminuer la distance d\'arrêt car cette distance dépend de notre vitesse.'
    ), (
        23,
        ...
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Dès le premier verre d\'alcool, des effets dangereux se font sentir, qui affectent notamment la vision : celle-ci peut se doubler, se troubler, le champ de vision est réduit, et les yeux sont plus sensibles à l\'éblouissement.',
        ...
        'Les usagers en fauteuil roulant ont le droit de circuler sur la chaussée :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Les usagers en fauteuil roulant ont en effet le droit de circuler sur la chaussée. Il faut faire très attention à eux car leur vitesse est réduite.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'Les remorques sont équipées de dispositifs réfléchissants :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Les remorques sont équipées de dispositifs réfléchissants afin de mieux les percevoir.',
        'Je me prépare à effectuer un dépassement plus long :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        ...
        '{\"D\": \"39 m\"}',
        'À 130 km/h, je parcours en 1 seconde 39 mètres. Pour calculer, je multiplie le chiffre des dizaines par 3 soit 13 x 3 = 39 m.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'Dans cette agglomération, j\'allume :',
        '{\"A\": \"Mes feux de croisement\", \"B\": \"Mes feux de route\"}',
        '{\"B\": \"Mes feux de route\"}',
        'Lorsque la route n\'est pas éclairée et que je suis seul, j\'allume les feux de route même en agglomération !',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'Grâce au radar de recul, je n\'ai pas besoin de regarder derrière moi en me retournant :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"B\": \"Non\"}',
        'Même si je dispose d\'un radar de recul, je dois toujours regarder derrière moi en me retournant pour voir en vision directe ce qu\'il se passe.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'Je vérifie l\'épaisseur du disque de frein :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Je vérifie l\'épaisseur du disque de frein en cas de dysfonctionnement des freins ou de perte de freinage. Cette vérification se fait chez un garagiste.',
        'Je vérifie l\'épaisseur des garnitures des plaquettes de frein :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Je vérifie également l\'épaisseur des garnitures des plaquettes de frein car ce sont elles qui assurent une bonne qualité de freinage.'
    ), (
        30,
        './images/Quiz/Question-4784.jpg',
        'En présence de ce panneau, je peux dépasser :',
        '{\"A\": \"Des voitures\", \"B\": \"Des motos sans side car\", \"C\": \"Des motos avec side car\"}',
        '{\"B\": \"Des motos sans side car\"}',
        'En présence de ce panneau, je peux dépasser uniquement des motos sans side-car.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Je surveille ce cycliste car il regarde à sa gauche comme s\'il voulait tourner.',
        'Je surveille le regard de ce cycliste :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Je surveille donc particulièrement son regard pour savoir la où il va tourner.'
    ), (
        33,
        './images/Quiz/Question-4785.jpg',
        'Le non-respect des distances de sécurité entraine une perte de :',
        '{\"A\": \"2 points\", \"B\": \"3 points\"}',
        '{\"B\": \"3 points\"}',
        'Le non-respect des distances de sécurité entraine une perte de 3 points. Le Code de la route prévoit aussi une amende forfaitaire de 135 euros, et la possibilité d\'une suspension de permis pour 3 ans maximum.',
        'En période probatoire, cette sanction entraine l\'obligation de suivre un stage pedagogique :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'En période probatoire, cette sanction entraine en effet l\'obligation de suivre un stage pédagogique car ce dernier est obligatoire dès qu\'une perte de 3 points est enregistrée.'
    ), (
        34,
        ...
        '{\"A\": \"A\", \"B\": \"B\", \"C\": \"C\"}',
        '{\"C\": \"C\"}',
        'La principale zone d\'incertitude se trouve en zone C car le bus masque les usagers qui pourraient être présents à droite du passage piétons.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'À l\'approche des virages, les feux adaptatifs améliorent la visibilité car ils suivent le tracé de la route dans le virage. Vous avez ainsi une bonne visibilité tout au long de la courbe du virage.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'Un motocycliste se plaint de ne pas bien respirer aprés son accident :',
        '{\"A\": \"Je retire son casque\", \"B\": \"J\'ouvre l\'écran ou visiere du casque\"}',
        '{\"B\": \"J\'ouvre l\'ecran ou visiere du casque\"}',
        'Je ne dois surtout pas retirer son casque car cela pourrait causer des blessures irréversibles. Je peux en revanche ouvrir la visière ou l\'écran de son casque afin qu\'il respire mieux.',
        'Il se plaint également de maux de dos. Je le déplace pour l\'asseoir :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"B\": \"Non\"}',
        'Je ne dois surtout pas le déplacer car cela pourrait causer des blessures irréversibles. Je peux en revanche le couvrir car un blessé en état de choc a froid.'
    ), (
        37,
        ...
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Les constats européens d\'accident sont faits selon un modèle qui est le même dans tous les pays : les informations sont les mêmes, demandées dans le même ordre, la page est identique. Ils peuvent donc être utilisés dans tous les pays européens, peu importe la langue dans laquelle ils ont été imprimés.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'Lorsque j\'anticipe une situation, je réduis mon temps de réaction :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Lorsque j\'anticipe les situations et les zones à risque, je réduis mon temps de réaction car ma décision sera plus rapide.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'Pour emprunter la voie tout à gauche, je dois être abonné au télépéage :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Pour emprunter la voie tout à gauche, je dois en effet être abonné au télépéage.',
        'Je paierai par carte bancaire :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"B\": \"Non\"}',
        'Je ne paierai pas par carte bancaire justement grâce au télépéage. J\'ai un bipeur dans ma voiture qui permet l\'ouverture de la barrière automatiquement.'
    ), (
        40,
        './images/Quiz/Question-4697.jpg',
        'Dans cette position :',
        '{\"A\": \"Je suis correctement installé\", \"B\": \"Je peux dormir en toute sécurité\", \"C\": \"Je risque des blessures en cas d\'ouverture de l\'airbag\"}',
        '{\"C\": \"Je risque des blessures en cas d\'ouverture de l\'airbag\"}',
        'Dans cette position, je risque des blessures en cas d\'ouverture de l\'airbag. Il ne faut surtout pas adopter ce genre d\'installation très dangereuse quoique très répandue sur les routes de vacances.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        'Je vérifie régulierement la pression de la roue de secours :',
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Je dois en effet vérifier régulièrement la pression de la roue de secours pour ne pas avoir de mauvaise surprise en cas de panne.',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        '{\"A\": \"Oui\", \"B\": \"Non\"}',
        '{\"A\": \"Oui\"}',
        'Il faut donc rajouter de l\'huile moteur au plus vite pour éviter une casse moteur.'
    ), (
        43,
        './images/Quiz/Question-4706.jpg',
        'Ce panneau indique :',
        '{\"A\": \"Un virage\", \"B\": \"Une voie de détresse\"}',
        '{\"B\": \"Une voie de détresse\"}',
        'Ce panneau indique une voie de détresse se situant à droite. La voie de détresse se rencontre dans les pentes descendantes, pour les véhicules dont les freins sont défaillants, elles sont repérées par un panneau particulier (représenté sur la photo) et se finissent par un bac à sable pour freiner le véhicule. Souvent, il y a un marquage au sol (damier rouge et blanc).',
        NULL,
        NULL,
        NULL,
        NULL
        ...
        '{\"A\": \"Une aide à la conduite\", \"B\": \"Un mode de location de véhicules\"}',
        '{\"B\": \"Un mode de location de véhicules\"}',
...
-- Dump completed on 2023-04-06 10:15:43
